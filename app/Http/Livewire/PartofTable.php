...
final class PartofTable extends PowerGridComponent
{
    use ActionButton;
    ...
    public function bulkCheckedDelete()
    {
        if (auth()->check()) {
            ...
            try {
                Partof::whereIn('id', $ids)->delete();
                $this->dispatchBrowserEvent('showToast', ['success' => true, 'message' => 'Data bagian berhasi dihapus.']);
    ...
    public function bulkCheckedEdit()
    {
        if (auth()->check()) {
            ...
            return $this->dispatchBrowserEvent('redirect', ['url' => route('partofs.edit', ['ids' => $ids])]);
        }
    }
    ...
    */
     ...
     *
     * @return Builder<\App\Models\Partof>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', fn (Partof $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'));
    }
