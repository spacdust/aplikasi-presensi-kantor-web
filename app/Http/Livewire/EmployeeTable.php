    ...
    */
    ...
    public function datasource(): Builder
    {
        return User::query()
            ...
            ->join('partofs', 'positions.partof_id', '=', 'partofs.id')
            ->select('users.*', 'partofs.name as partof', 'positions.name as position');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('email')
            ->addColumn('phone')
            ->addColumn('partof', function (User $model) {
                return ucfirst($model->partof);
            })
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Bagian', 'partof', 'partofs.name')
                ->searchable()
                ->sortable(),
