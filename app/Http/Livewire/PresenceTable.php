    ...
    */
    ...
    public function datasource(): Builder
    {
        return Presence::query()
            ...
            ->whereDate('presences.presence_date', now()->toDateString()) //today date
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn("presence_out_time", fn (Presence $model) => $model->presence_out_time ?? '<span class="badge text-bg-danger">Belum Presensi Pulang</span>')
            ...
            // ->addColumn("working_hours", fn (Presence $model) => $model->working_hours ?? '<span class="badge text-bg-danger">Belum Presensi Pulang</span>')
            // ->addColumn("status")
            // ->addColumn("working_time_status", fn (Presence $model) => $model->is_working_hours_status ?
            //     '<span class="badge text-bg-success">Cukup</span>' : '<span class="badge text-bg-danger">Kurang</span>')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Keterangan', 'is_permission')
                ->sortable(),

            Column::make('Status', 'status')
                ->sortable(),

            // Column::make('Waktu Kerja', 'working_hours')
            //     ->sortable(),

            // Column::make('Status Waktu Kerja', 'working_time_status')
            //     ->sortable(),
