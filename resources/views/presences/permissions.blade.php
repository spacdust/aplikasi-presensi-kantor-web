            ...
            <div class="row">
                <div class="col-md-6 mb-3 mb-md-0">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <span href="" class="badge text-bg-warning">Pegawai Izin</span>
                    </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <ul>
                            <li>Judul Izin : {{ $permission->title }}<span id="permission-title"></span></li>
                            <li>Keterangan Izin : {{ $permission->description }}<p id="permission-description"></p>
                            </li>
                        </ul>
                    </div>
