                ...
                <div class="w-100">
                    ...
                    <div class="mb-3">
                        <x-form-label id="password{{ $i }}"
                            label='Password Pegawai {{ $i + 1 }} (default: "123" jika tidak diisi)'
                            required="false" />
                    ...
                    <div class="mb-3">
                        <x-form-label id="position_id{{ $i }}" label='Posisi {{ $i + 1 }}' />
                        <select class="form-select" aria-label="Default select example" name="position_id"
                            wire:model="employees.{{ $i }}.position_id">
                    ...
                    @if ($i > 0)
                        <button class="btn btn-sm btn-danger mt-2"
                            wire:click="removeEmployeeInput({{ $i }})"
