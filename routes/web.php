...
use App\Http\Controllers\PartofController;
...
Route::middleware('auth')->group(function () {
    Route::middleware('role:admin')->group(function () {
        ...
        // jabatans
        Route::resource('/partofs', PartofController::class)->only(['index', 'create']);
        Route::get('/partofs/edit', [PartofController::class, 'edit'])->name('partofs.edit');
        // employees
        ...
        //loacation page (halaman lokasi)
        Route::resource('/locations', LocationController::class)->only(['index', 'create']);
        Route::post('locations/create/store', [LocationController::class, 'store'])->name('store');

        //halaman rekap
        Route::resource('/statistics', StatisticController::class)->only(['index']);
        Route::get('/statistics/{attendance}/show', [StatisticController::class, 'show'])->name('statistics.show');
        // Route::get('/statistics/{attendance}/showall', StatisticController::class, 'showall')->name(['statistics.showall']);
    });
